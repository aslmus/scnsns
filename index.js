...
const UUID = process.env.UUID || '1b6671ce-daba-4769-a195-0a77043d3794'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'scnsns.susns.sbs';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNThjM2YzYjhhNWQ4ZGZjMzlmMWRjOTE2MDc3NDhkODciLCJ0IjoiZmM2MjY2ZDEtMjZlYy00YTg5LWIzY2MtMDk1ZDk5YmE5OWFlIiwicyI6IlltWmhOemhrWTJZdFpqYzJNeTAwTkRnNUxXSXpNR1V0TmpSa01EVXdZamRqT1RCaiJ9
...
const NAME = process.env.NAME || 'scns';                        // 节点名称
